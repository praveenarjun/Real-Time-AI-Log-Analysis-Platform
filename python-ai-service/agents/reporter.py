...
class ReporterAgent:
    ...
    def generate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        messages = [
            ...
            HumanMessage(content=f"Generate a professional incident report from this forensics data: \n\n{json.dumps(context)}")
        ]
        ...
        try:
            ...
            logger.warning(f"AI Quota issue in Reporter. Generating local Executive Verdict. Error: {e}")
